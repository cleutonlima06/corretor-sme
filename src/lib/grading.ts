...
export function getCategoryColor(category: PerformanceCategory) {
  switch (category) {
    ...
    case 'INTERMEDIÁRIO': return 'bg-yellow-500'; // Amarelo conforme solicitado
...
export function getCategoryTextColor(category: PerformanceCategory) {
  switch (category) {
    ...
    case 'INTERMEDIÁRIO': return 'text-yellow-600'; // Amarelo conforme solicitado
...
export function getCategoryBadgeClasses(category: PerformanceCategory) {
  switch (category) {
    ...
    case 'INTERMEDIÁRIO': return 'bg-yellow-100 text-yellow-700 border-yellow-200'; // Estilo amarelo
